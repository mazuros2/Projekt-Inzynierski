	...
	public void run(String... args) throws Exception {
		...
		if(klubRepository.count() == 0) {
			...
			Zawodnik KT = Zawodnik.builder()
					...
					.waga(80)
					.wzrost(191)
					.profiloweURL("https://umpire-media-files.s3.us-east-1.amazonaws.com/777cab38-18b4-4ae2-a11e-6a134a8542ab/1721128486_1_Kacper_Tobiasz.png")
					.kraj_pochodzenia(Set.of(PL))
					.pozycja(bramkarzBR)
			...
			Zawodnik PW = Zawodnik.builder()
					...
					.waga(78)
					.wzrost(186)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/big/164759-1677703476.png")
					.kraj_pochodzenia(Set.of(PL))
					.pozycja(obroncaPO)
					.obecny_klub(new HashSet<>())
					.transfery(new ArrayList<>())
			...
			Zawodnik RP = Zawodnik.builder()
					...
					.role(Role.ZAWODNIK)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/big/322798-1694615400.png")
					.waga(80)
					.wzrost(185)
			...
			Zawodnik arturJedrzejczyk = Zawodnik.builder()
					...
					.waga(78)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/big/42401-1677703217.png?lm=1")
					.wzrost(189)
					.pozycja(obroncaSO)
			...
			Zawodnik bartoszKapustka = Zawodnik.builder()
					...
					.waga(67)
					.wzrost(179)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/big/246579-1677703549.png?lm=1")
					.pozycja(pomocnik)
			...
			Zawodnik marcGual = Zawodnik.builder()
					...
					.waga(73)
					.wzrost(184)
					.profiloweURL("https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQ-kj8XEW3aJcdivswmR-iURivM0rs10BxffIN0PLLUh2V-AhHStmEPslVhjHTl1HbI6cMXKY0b9uhifn2S68v8b_GymUZcDIhnHgCrVg")
					.pozycja(napastnikSN)
			...
			Zawodnik MarcelMendesDudzinski = Zawodnik.builder()
					...
					.pesel(20050514)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/big/717910-1704295440.jpg?lm=1")
					.role(Role.ZAWODNIK)
			...
			Zawodnik RubenVinagre = Zawodnik.builder()
					...
					.pesel(19990409)
					.role(Role.ZAWODNIK)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/357158-1721813075.png?lm=1")
			...
			Zawodnik JurgenCelhaka = Zawodnik.builder()
					...
					.nazwisko("Celhaka")
					.pesel(20001206)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/622727-1677704041.png?lm=1")
					.role(Role.ZAWODNIK)
			...
			Zawodnik JuergenElitim = Zawodnik.builder()
					...
					.imie("Juergen")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/607057-1694615573.png?lm=1")
					.nazwisko("Elitim")
					.pesel(19990713)
					.role(Role.ZAWODNIK)
			...
			Zawodnik JeanPierreNsame = Zawodnik.builder()
					...
					.imie("Jean-Pierre")
					.nazwisko("Nsame")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/225055-1721813549.png?lm=1")
					.pesel(19930501)
					.role(Role.ZAWODNIK)
			...
			Zawodnik TomasPekhart = Zawodnik.builder()
					...
					.nazwisko("Pekhart")
					.pesel(19890526)
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/38746-1677704738.png?lm=1")
					.role(Role.ZAWODNIK)
			...
			Zawodnik BartoszSalamon = Zawodnik.builder()
					...
					.imie("Bartosz")
					.nazwisko("Salamon")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/71019-1671294361.png?lm=1")
			...
			Zawodnik BartoszMrozek = Zawodnik.builder()
					...
					.imie("Bartosz")
					.nazwisko("Mrozek")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/345452-1675375791.jpg?lm=1")
			...
			Zawodnik JoelPereira = Zawodnik.builder()
					...
					.imie("Joel")
					.nazwisko("Pereira")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/225165-1671293456.png?lm=1")
			...
			Zawodnik RadoslawMurawski = Zawodnik.builder()
					...
					.imie("Radosław")
					.nazwisko("Murawski")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/220969-1671294953.png?lm=1")
			...
			Zawodnik FilipSzymczak = Zawodnik.builder()
					...
					.imie("Filip")
					.nazwisko("Szymczak")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/554972-1671295388.png?lm=1")
			...
			Zawodnik MikaelIshak = Zawodnik.builder()
					...
					.imie("Mikael")
					.nazwisko("Ishak")
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/153637-1671295208.png?lm=1")
			...
			Trener NF = Trener.builder()
					...
					.profiloweURL("https://img.a.transfermarkt.technology/portrait/header/9253-1733215902.jpg?lm=1")
					.build();
